...
As a note for whoever is grading this, inline with my github commits, I had solved problem 1 my own way prior to the release of the solution. I have kept it as such as my cleaning and merging produced a similar dataset, just with different naming conventions.

The `pols_month` dataset contains data regarding the number of politicians based on party affiliation on a monthly basis from 1947 to 2015.
